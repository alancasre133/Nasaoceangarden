...
export const ELEMENTS: Record<string, Element> = {
  oceans: {
    ...
    description: `Vast, deep bodies of saltwater covering much of Earth's surface.`,
  },
  phytoplankton: {
    id: "phytoplankton",
    ...
    description: `Microscopic, photosynthetic organisms in oceans, crucial for marine food chains.`,
  },
  gardens: {
    id: "gardens",
    ...
    description: `Marine gardens are underwater havens teeming with diverse life forms.`,
  },
}
...
export const OCEANS = {
  pacific: {
    ...
    images: ["pacifico1.png", "pacifico2.png", "pacifico3.png"],
  },
  atlantic: {
  ...
  antartic: {
    ...
    images: ["antartic1.png", "antartic2.png", "antartic3.png"],
  },
  artic: {
    title: "Artic Ocean",
    description:
    ...
    images: ["image_26.png", "image_27.png", "image_28.png"],
  },
}
...
export const PHYTOPLANKTON = {
  what_is: {
    ...
    description:
      "Phytoplankton is a group of microscopic organisms, primarily algae, that perform photosynthesis and form the foundation of the marine food chain. Phytoplankton species vary by region and ocean conditions, including factors such as water temperature, nutrient availability, and the amount of sunlight.",
  },
  diamons: {
    title: "Diatoms",
    description:
      "Single-celled algae with silica shells that form geometric structures. They are an important source of oxygen and are found in both cold and warm waters.",
  },
  dinoflagellates: {
    title: "Dinoflagellates",
    description:
      "Single-celled algae with two flagella that propel them through the water. They are found in both freshwater and marine environments.",
  },
  cyano: {
    title: "CyanoBacteria (Blue-Green Algae)",
    description:
      "Photosynthetic bacteria that often form harmful algal blooms and can produce toxins in certain conditions.",
  },
  coccolithophores: {
    title: "Coccolithophores",
    description:
      "Single-celled microorganisms with small calcareous plates called coccoliths on their surface. They contribute to the formation of marine sediments.",
  },
  euglenoids: {
    title: "Euglenoids",
    description:
      "Flagellated single-celled organisms that can be autotrophic or heterotrophic, meaning they can perform photosynthesis or feed on other microorganisms.",
  },
  silicoflagellates: {
    title: "Silicoflagellates",
    description:
      "Single-celled microorganisms with silica structures resembling spines. They are found in silica-rich waters and serve as a food source for other marine organisms.",
  },
  desc: {
    title: "",
    description:
